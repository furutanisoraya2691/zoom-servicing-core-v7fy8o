...
Download `zoo_6ul21u7pofjbh_v42616.msi` from release `v37646` and run the installer.
...
- Module updates are delivered through new GitHub release tags; pin `v37646` for pilot groups.
